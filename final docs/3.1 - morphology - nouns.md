...
Words with a final glottal stop interact with the suffix to give slightly different inflections.  Example noun is *qâ* 'what'
...
Similar to demonstrative/interrogative pronouns above, quantifiers can also be used as *indefinite pronouns*.  Using the appropriate class form, they also inflect for case and number.  Some examples are given below.  Additionally, *rhe* 'one' can be used meaning 'something/someone', and takes on class endings as well as case and number.
